...
> Para isso pode-se adicionar brakpoints. Para isso, basta digitar **breakpoints** e o nome da função.<subs>(Pode se ao digitar o nome da mesma, usar o **tab** para completar o nome da função).</subs>
